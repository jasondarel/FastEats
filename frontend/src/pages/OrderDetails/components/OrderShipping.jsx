...
import { getProvincesService, getCitiesService, getDistrictsService, getVillagesService } from "../../../service/utilServices/utilService";
...
const OrderShipping = () => {
    const [useCurrentInfo, setUseCurrentInfo] = useState(true);
      ...
      const handleShippingChange = (field, value) => {
        ...
        // Reset dependent fields and load new data
        if (field === 'province') {
          setShippingData(prev => ({
            ...prev,
            city: '',
  ...
  return (
    <div>
        <div className="mt-8 p-6 bg-amber-50 rounded-lg">
          ...
          {/* Button to toggle between current and new information */}
          ...
          {/* Shipping form - only show when using new information */}
          {!useCurrentInfo && (
